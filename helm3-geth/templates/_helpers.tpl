...
{{- $args = concat $args (list "--statediff" "--syncmode" .Values.syncMode "--pprof" "--pprof.addr=0.0.0.0") -}}
...
{{- $writing := default false .Values.statediff.writing -}}
{{- if $writing -}}
  {{- $args = concat $args (list "--statediff.writing" "--statediff.db" .Values.statediff.db.url) -}}
  {{- $args = concat $args (list "--statediff.dbnodeid" .Values.statediff.db.nodeId "--statediff.dbclientname" .Values.statediff.db.clientName) -}}
{{- end -}}
